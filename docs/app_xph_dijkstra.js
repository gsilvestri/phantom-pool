...
app.controller('indexCtrl', function($scope, $http) {
    ...
    $http.get ('poollogs_xph_dijkstra.json').then (function (res) {
    ...
    $http.get ('https://phantom.api.cryptdelegate.com/api/delegates/get?username=xph_dijkstra').then (function (res) {
